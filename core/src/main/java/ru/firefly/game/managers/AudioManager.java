...
public class AudioManager {
    ...
    public Sound upsSound;

    public AudioManager() {
        backgroundMusic = Gdx.audio.newMusic(Gdx.files.internal(GameResources.BACKGROUND_MUSIC_PATH));
        explosionSound = Gdx.audio.newSound(Gdx.files.internal(GameResources.PUM_SOUND_PATH));
        upsSound = Gdx.audio.newSound(Gdx.files.internal(GameResources.UPS_SOUND_PATH));
